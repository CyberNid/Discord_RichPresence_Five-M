Citizen.CreateThread(function()
	while true do
		SetDiscordAppId() -- ID de votre bot
		SetDiscordRichPresenceAsset('') -- Votre Grand photo de votre bot
        SetDiscordRichPresenceAssetText('') -- Le texte quand vous passer votre sourie sur l'image
        SetDiscordRichPresenceAssetSmall('') -- votre ptit image de votre bot
        SetDiscordRichPresenceAssetSmallText('') -- le texte quand vous passez votre sourie sur la petit img
		SetDiscordRichPresenceAction(0, "Nom De Votre Button", "Le lien que vous vouler mettre")
		SetDiscordRichPresenceAction(1, "Nom De Votre Button", "Le lien que vous vouler mettre")
		Citizen.Wait(60000)
	end
end)
Citizen.CreateThread(function()
